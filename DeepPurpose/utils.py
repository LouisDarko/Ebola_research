...
# ESPF encoding
vocab_path = '/Users/louis/Desktop/Ebola_research/DeepPurpose/ESPF/drug_codes_chembl_freq_1500.txt'
bpe_codes_drug = codecs.open(vocab_path)
dbpe = BPE(bpe_codes_drug, merges=-1, separator='')
sub_csv = pd.read_csv('/Users/louis/Desktop/Ebola_research/DeepPurpose/ESPF/subword_units_map_chembl_freq_1500.csv')

idx2word_d = sub_csv['index'].values
words2idx_d = dict(zip(idx2word_d, range(0, len(idx2word_d))))

vocab_path = '/Users/louis/Desktop/Ebola_research/DeepPurpose/ESPF/protein_codes_uniprot_2000.txt'
bpe_codes_protein = codecs.open(vocab_path)
pbpe = BPE(bpe_codes_protein, merges=-1, separator='')
#sub_csv = pd.read_csv(dataFolder + '/subword_units_map_protein.csv')
sub_csv = pd.read_csv('/Users/louis/Desktop/Ebola_research/DeepPurpose/ESPF/subword_units_map_uniprot_2000.csv')
...
def generate_config(drug_encoding, target_encoding = None, 
					result_folder = "/Users/louis/Desktop/Ebola_research/result/",
					input_dim_drug = 1024, 
